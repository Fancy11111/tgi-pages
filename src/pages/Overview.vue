    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Hamming Code</p>
            </div>
          </div>
          ...
          <div class="content">
            <ul>
              <li>
                <router-link to="/hamming-code">Hamming Code</router-link>
              </li>
              <li>
                <router-link to="/hamming-distance"
                  >Hamming Distanz</router-link
                >
              </li>
            </ul>
          </div>
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Morse Code</p>
            </div>
          </div>
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">NRZ und co</p>
            </div>
          </div>
          ...
          <div class="content">
            <ul>
              <li>
                <a
                  href="http://www.ece.unb.ca/cgi-bin/tervo/encoding.pl"
                  target="_blank"
                  >NRZ und co</a
                >
              </li>
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Polynom Code</p>
            </div>
          </div>
          ...
          <div class="content">
            <ul>
              ...
              <li>
                <a
                  href="http://public.hochschule-trier.de/~knorr/crc.php"
                  target="_blank"
                  >Polynomcode</a
                >
              </li>
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Wahrscheinlichkeitsrechner</p>
            </div>
          </div>
            ...
            <ul>
              <li>
                <a
                  ...
                  target="_blank"
                  >Würfel-Wahrscheinlichkeitsrechner</a
                >
              </li>
            </ul>
          </div>
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Schaltungen</p>
            </div>
          </div>
          ...
          <div class="content">
            <ul>
              ...
              <li>
                <a
                  href="http://falstad.com/circuit/circuitjs.html"
                  target="_blank"
                  >Schaltkreise</a
                >
              </li>
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Boolesche Algebra</p>
            </div>
          </div>
          ...
          <div class="content">
            <ul>
              <li>
                <router-link to="/truth-table">Wahrheitstabelle</router-link>
              </li>
              <li>
                <a
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Huffman Code</p>
            </div>
          </div>
            ...
            <ul>
              <li>
                <a href="https://planetcalc.com/2481/" target="_blank"
                  >Huffman-Code (Durchschnittliche Wortlänge, welche
                  ausgerechnet wird von der Site, nicht verwenden!): Info:
                  Kleinere Zahlen: 0, Größere Zahlen: 1 (Man kann links unten
                  invertieren)</a
                >
              </li>
              <li>
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          <div class="media">
            <div class="media-content">
              <p class="title is-4">Binär Rechner</p>
            </div>
          </div>
          ...
          <div class="content">
            <ul>
              <li>
                <router-link to="/binary-coding">Binäre Codierung</router-link>
              </li>
              <li>
                <router-link to="/binary-calculator">Binär Rechner</router-link>
              </li>
              <li>
                <a
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  >Binär umrechnen (Bei direkten Umrechnungen kann es
                  Rundungsfehler geben, da der Rechner immer über das
                  10er-System geht.)</a
                >
              </li>
              <li>
                <a
                  ...
                  target="_blank"
                  >Binär Operationen (+, -, *, /) (Komma Zahlen funktionieren
                  nicht)</a
                >
              </li>
              <li>
        ...
        <div class="card-content">
          ...
          <div class="content">
            <ul>
              <li>
                <a
                  href="https://github.com/tuwien2020/tgi-pages"
                  target="_blank"
                  >TGI Pages</a
                >
              </li>
